...
Bubbles = () ->
  ...
  rValue = (d) -> parseInt(d.count) ## LOGARITMO MENCIONAR
  ...
  updateNodes = () ->
    ...
    nodeSentiment = (d) ->
      if d.sentiment == 'positive' then 'positive' else 'negative'
    node.enter()
      .append("a")
      .attr("class", 'bubble-node')
      .attr("class", (d) -> 'bubble-node ' + if d.sentiment == 'positive' then 'positive' else 'negative')
